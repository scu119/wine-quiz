...
const resultsData = {
    red: {
        ...
        B: {
            ...
            alt: { name: "DON TOMASI, JATO ROSSO", price: 74, imgSrc: "assets/don_tomasi_jato_rosso_nobg.png", description: { en: "Shiraz, Nero D'avola, Sicilia. A fragrant wine displaying supple tannins, subtle herbal nuances, and remarkable balance on the palate.", ko: "섬세한 허브의 뉘앙스와 유연한 탄닌이 어우러진 향기로운 와인으로, 입안에서는 뛰어난 밸런스를 보여줍니다." } }
        },
        C: {
            main: { name: "DON TOMASI, JATO ROSSO", price: 74, imgSrc: "assets/don_tomasi_jato_rosso_nobg.png", description: { en: "Shiraz, Nero D'avola, Sicilia. A fragrant wine displaying supple tannins, subtle herbal nuances, and remarkable balance on the palate.", ko: "섬세한 허브의 뉘앙스와 유연한 탄닌이 어우러진 향기로운 와인으로, 입안에서는 뛰어난 밸런스를 보여줍니다." } },
    ...
    white: {
        A: {
            main: { name: "CANICATTI, GRILLO DOC", price: 69, imgSrc: "assets/Grillo Canicatti_nobg.png", description: { en: "100% Grillo, Sicilia. Well-ended and harmonious scents. On the palate decisive, fruity, with an appropriate acidic component.", ko: "잘 마무리되고 조화로운 향기. 맛은 결정적이며 과일 향이 나며 적절한 산성이 들어 있습니다." } },
            altLabel: { en: "Want something more aromatic and smooth?", ko: "좀 더 향긋하고 부드러운 와인을 원하시나요?" },
            alt: { name: "LA KIUVA, ROSE' DE VALLE", price: 76, imgSrc: "assets/La-kiuvarose_nobg.png", description: { en: "70% Picotendro, 30% Gros Vien, Neyret, Cornalin and Fumin, Valle D'Aosta. Aromas of fresh red berries and wild fruit; on the palate it is fresh and mineral with a delicate bitter finish.", ko: "신선한 붉은 베리와 야생 과일 향이 나며, 입안에서는 상쾌하고 미네랄감이 느껴지고 끝에는 은은한 쓴맛이 남습니다." } }
        },
        B: {
            main: { name: "DON TOMASI, JATO' LUCIDO", price: 74, imgSrc: "assets/don_tomasi_jato lucido_nobg.png", description: { en: "100% Catarratto Lucido, Sicilia. An elegant profile of ripe white fruit and zesty citrus, balanced by subtle minerality.", ko: "잘 익은 백색 과일과 상큼한 감귤 향, 은은한 미네랄과 아몬드 뉘앙스가 어우러진 우아한 풍미입니다." } },
            altLabel: { en: "Want something more mineral?", ko: "좀 더 미네랄리티가 풍부한 와인을 원하시나요?" },
            alt: { name: "PRIMA PIETRA, SOAVE DOC", price: 62, imgSrc: "assets/335_58.Prima Pietra SOAVE_nobg.png", description: { en: "100% Garganega, Veneto. Citrus and floreal notes, green fruits finishing with smooth acidity.", ko: "시트러스와 꽃향기가 느껴지고 풋과실 상큼함이 고소한 견과류향과 마지막을 장식합니다." } }
        },
        C: {
            ...
            alt: { name: "VILLA SPARINA, GAVI DOCG", price: 87, imgSrc: "assets/Villa-Sparina-Gavi_nobg.png", description: { en: "100% Cortese, Piemonte. Floreal notes with aromas of yellow fruits and tropical fruit. Long finish with soft acid and persinstent structure.", ko: "꽃 향이 어우러진 과일향 풍부하고, 애씨드 구조로 롱 피니쉬가 느껴집니다." } }
        },
        D: {
            ...
            alt: { name: "DON TOMASI, JATO' LUCIDO", price: 74, imgSrc: "assets/don_tomasi_jato lucido_nobg.png", description: { en: "100% Catarratto Lucido, Sicilia. An elegant profile of ripe white fruit and zesty citrus, balanced by subtle minerality.", ko: "잘 익은 백색 과일과 상큼한 감귤 향, 은은한 미네랄과 아몬드 뉘앙스가 어우러진 우아한 풍미입니다." } }
        }
    },
    sparkling: {
        A: {
        ...
        D: {
            ...
            alt: { name: "VILLA SANDI IL FRESCO BRUT", price: 68, imgSrc: "assets/il-fresco-prosecco-doc-treviso_nobg.png", description: { en: "100% Glera, Veneto. Strong fruity scent and elegant floral scent reminiscent of acacia along with aromas of ripe golden apple and northern pine.", ko: "과실향이 강렬하며 잘 익은 금빛 사과, 복숭아 등의 아로마와 함께 아카시아를 연상시키는 우아한 꽃 향을 가졌습니다." } }
        }
    },
    surprise: {
        A: {
        ...
        C: {
            main: { name: "LA KIUVA, ROSE' DE VALLE", price: 76, imgSrc: "assets/La-kiuvarose_nobg.png", description: { en: "70% Picotendro, 30% Gros Vien, Neyret, Cornalin and Fumin, Valle D'Aosta. Aromas of fresh red berries and wild fruit; on the palate it is fresh and mineral with a delicate bitter finish.", ko: "신선한 붉은 베리와 야생 과일 향이 나며, 입안에서는 상쾌하고 미네랄감이 느껴집니다." } },
            altLabel: { en: "Want more mineral and fresh?", ko: "좀 더 상쾌한 미네랄이 필요하신가요?" },
            alt: { name: "DON TOMASI, JATO' LUCIDO", price: 74, imgSrc: "assets/don_tomasi_jato lucido_nobg.png", description: { en: "100% Catarratto Lucido, Sicilia. An elegant profile of ripe white fruit and zesty citrus, balanced by subtle minerality.", ko: "잘 익은 백색 과일과 상큼한 감귤 향, 은은한 미네랄이 어우러진 우아한 풍미입니다." } }
        },
        D: {
            ...
            alt: { name: "VILLA SPARINA, GAVI DOCG", price: 87, imgSrc: "assets/Villa-Sparina-Gavi_nobg.png", description: { en: "100% Cortese, Piemonte. Floreal notes with aromas of yellow fruits and tropical fruit. Long finish with soft acid and persinstent structure.", ko: "꽃 향이 어우러진 과일향, 탄탄한 구조감의 화이트 와인입니다." } }
        }
    }
};
